...
public class InMemoryTaskRepository implements TaskRepository {
    ...
    private final List<TaskComment> commentStore = new ArrayList<>();
    private final List<TaskActivity> activityStore = new ArrayList<>();
    ...
    @Override
    public List<TaskActivity> getAllTaskActivity() {
