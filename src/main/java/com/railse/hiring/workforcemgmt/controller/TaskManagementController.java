...
public class TaskManagementController {
    ...
    @PatchMapping("/task/priority")
    public Response<String> updatePriority(@RequestBody TaskPriorityUpdateRequest priorityUpdateRequest){
        return new Response<>(taskManagementService.updatePriority(priorityUpdateRequest));
    }
    ...
    public Response<String> addComment(@PathVariable Long id, @RequestBody AddCommentRequest request) {
        taskManagementService.addComment(id, request.getCommentText(), request.getUserId());
